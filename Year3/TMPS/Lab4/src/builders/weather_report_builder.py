...
from Year3.TMPS.Lab4.src.models.models import Location, Current, Day
from Year3.TMPS.Lab4.src.models.weather_report_models import BaseWeatherReport, StandardWeatherReport, AdvancedWeatherReport, Astronomy
